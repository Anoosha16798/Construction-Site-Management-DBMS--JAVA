 ...
 * @author Anoosha I A
 */
public class Planning3Servlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String FlooringType= request.getParameter("FlooringType");
         String DoorType= request.getParameter("DoorType");
           int Contract_id= Integer.parseInt(request.getParameter("Contract_id"));
      
         
         
        // out.print("Contract_id"+Contract_id+"FlooringType"+FlooringType+"DoorType"+DoorType);
         
         
           
           String qry= "insert into Flooring values ('"+Contract_id+"','"+FlooringType+"','"+DoorType+"')";
